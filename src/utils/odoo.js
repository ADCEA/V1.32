 ...
 * jour avec les dernières informations connues (SIRET, TVA, adresse de
 * facturation). Recherche d'abord par email (idempotent : un ré-essai
 * après un problème réseau ne crée jamais de doublon). Retourne l'id
 * Odoo du partenaire.
 *
 ...
 * par la localisation française (l10n_fr) — s'il n'est pas installée sur
 * cette instance, Odoo renverra une erreur explicite sur ce champ précis
 ...
 * (Odoo génère le PDF au moment de la validation, ça peut prendre un
 * instant après le passage à "posted").
 *
